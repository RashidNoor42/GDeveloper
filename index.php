      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="contact.php" class="btn btn-primary btn-outline-white px-5 py-3">Get in touch</a></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid" data-scrollax-parent="true">
            ...
            <a href="#" class="featured-img">
              ...
              <div class="text p-4 d-flex align-items-center">
                <div class="user d-flex align-items-center">
                  ...
                  <h3>Taqdees Zafar <br><span class="position">Designer</span></h3>
                </div>
              </div>
            </a>
          </div>
                ...
                <div class="row no-gutters d-flex align-items-end">
                  ...
                  <div class="col-md-8">
                    <a href="#" class="featured-img">
                      ...
                      <div class="text p-4 d-flex align-items-center">
                        <div class="user d-flex align-items-center">
                          <div class="user-img mr-3" style="background-image: url(images/person_2.jpg);"></div>
                          <h3>Rashid Noor <br><span class="position">Designer</span></h3>
                        </div>
                      </div>
                    </a>
                  </div>
                ...
                <div class="row no-gutters d-flex align-items-start">
                  <div class="col-md-8">
                    <a href="#" class="featured-img">
                      ...
                      <div class="text p-4 d-flex align-items-center">
                        <div class="user d-flex align-items-center">
                          <div class="user-img mr-3" style="background-image: url(images/person_3.jpg);"></div>
                          <h3>Salman Iqbal <br><span class="position">Designer</span></h3>
                        </div>
                      </div>
                    </a>
                  </div>
        ...
        <div class="row mt-5 d-flex justify-content-center">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="h1">UI/UX, visual, <strong class="px-3">Web designer</strong> with more than 2 years of experience in designing websites and mobile apps.</h2>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-6 text-center heading-section ftco-animate">
            ...
            <p>We usually deal with Mobile App Development & Web Development, hire us to translate your imaginations and ideas in reality. We are experienced to give you your desired results according to your wishes.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>What we need to do is always lean into the future; when the world changes around you and when it changes against you - what used to be a tail wind is now a head wind - you have to lean into that and figure out what to do because complaining isn't a strategy.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
        ...
        <div class="container">
          <div class="row d-flex justify-content-center">
            <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
              ...
              <p>To access all of our premium content, including invaluable research, insights, elearning, data and tools, you need to be a subscriber. Your team and your organisation to a wealth of resources designed to help you achieve excellence in marketing.</p>
      ...
      <div class="container">
        <div class="row no-gutters justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <p>Seamless collaboration, total transparency, secure delivery. We’ve developed a better approach to custom software development. We pride ourselves on our ability to demystify digital trends and cut through the jargon. Our approach is broken into four distinct, straightforward models. 
            We’ll personally guide you through the best options to fulfill your business needs in the most efficient way possible.</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              ...
              <div class="text p-4 d-block">
                ...
                <h3 class="heading"><a href="#">Technology and Development Center For Global Development</a></h3>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry" data-aos-delay="100">
              ...
              <div class="text p-4">
                ...
                <h3 class="heading"><a href="#">Daily food magazine published by the founders of Apartment Therapy.</a></h3>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry" data-aos-delay="200">
              ...
              <div class="text p-4">
                ...
                <h3 class="heading"><a href="#">Crystal Couples: Crystal Pairings For Every Intention, 6 Ways To Work With A Crystal</a></h3>
              </div>
            </div>
          </div>
        </div>
